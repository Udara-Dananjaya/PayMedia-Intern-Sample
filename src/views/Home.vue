  ...
  <div class="user-table">
    ...
    <div v-if="showAddForm" class="modal">
      ...
      <form @submit.prevent="addUser">
        ...
        <input type="text" id="addName" v-model="newUser.name" required>

        <label for="addEmail">Email:</label>
        <input type="email" id="addEmail" v-model="newUser.email" required>

        <label for="addPass">Password:</label>
        <input type="password" id="addPass" v-model="newUser.pass" required>

        <label for="addImage">Image:</label>
        <input type="file" id="addImage" @change="handleNewFileChange">
